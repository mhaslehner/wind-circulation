...
def harmonics(params, x, numpoly, numharm):
      ...
      # harmonic part
      pi2 = 2*pi*x
      if numharm > 0: # what if numharm == 4??
...
class ccgFilter:
    ...
    def __init__(self, xp, yp, shortterm=80, longterm=667, sampleinterval=0, numpolyterms=3, numharmonics =4, timezero = -1, gap=0, debug=False):
      ...
      set_the_sample_interval = True
      if set_the_sample_interval == True:
        if sampleinterval == 0:
            ...
            if debug:
                    ...
                    ("changed sampleinterval to ", self.sampleinterval)
        else:
      ...
      # added on Jan 22nd 2020
      #print('dinterval',self.dinterval)
...
#     rmean = numpy.mean(r)
      ...
      if self.debug:
            print( "rsd about smooth curve is", self.rsd2)
    ...
    def _filter_data(self, gap):
      ...
      if self.debug:
            ...
            print( "    rmean = %e, rsd = %e" % (rmean, self.rsd1))
